...
- A stronger understanding of the C language
- A reusable foundation for all subsequent projects
- A library that can be easily linked to any C program

---

## Objective

The main aim of this project is to deepen your knowledge of:
- String and memory manipulation in C
- Low-level operations (`malloc`, `free`, `write`, etc.)
- Writing safe, reliable, and robust code
- Structuring modular and maintainable C programs
...
```bash
git clone https://github.com/bernardofg/42Libft.git
```
